...
public class SelectASnack extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_select_a_snack);
        meal_rv = findViewById(R.id.meal_recycler_view);
        addDish = findViewById(R.id.addDishBtn);
        addDish.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(SelectASnack.this, AddDish.class);
        ...
        saveBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(SelectASnack.this, HomePage.class);
                startActivity(intent);
            }
        });
