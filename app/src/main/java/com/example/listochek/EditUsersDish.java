...
public class EditUsersDish extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_users_dish);
    ...
    private void loadMealData(String mealId) {
        DocumentReference docRef = db.collection("meal")
                .document("usersMeal")
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    if (document != null && document.exists()) {
                        ...
                        Toast.makeText(EditUsersDish.this, "Failed to load meal data", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Toast.makeText(EditUsersDish.this, "Failed to load meal data", Toast.LENGTH_SHORT).show();
                }
        ...
        docRef.update("name", name, "weight", weight, "calories", calories, "protein", protein, "fats", fats, "carbohydrates", carbs)
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()) {
                            Toast.makeText(EditUsersDish.this, "Блюдо успешно обновлено", Toast.LENGTH_SHORT).show();
                            Intent intent = new Intent(EditUsersDish.this, UsersDishes.class);
                            startActivity(intent);
                            finish();
                        } else {
                            Toast.makeText(EditUsersDish.this, "Ошибка при обновлении блюда", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
